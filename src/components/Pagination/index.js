...
class Pagination extends Component {
    ...
    onClick(evt) {
        ...
        this
            .props
            .paginationAction(evt.currentTarget.attributes.href.value, this.props);
    }
    ...
    getStyle(props, page) {
        return Number(props.pagination.current) === page
    ...
    previous() {
        this
            .props
            .paginationPrevAction(this.props);
    }

    next() {
        this
            .props
            .paginationNextAction(this.props);
    }
            ...
            <div className='pagination'>
                <div className='pagination__content'>
                    {this.props.pagination.prev
                        ? this._paginationLink(-1, 'previous', 'prev')
                        : null}
                    {this
                        .props
                        .pagination
                        ...
                        .map((data, index) => {
                            return <PagiLink
                                className={this.getStyle(this.props, data + 1)}
                                onClick={this
                                .onClick
                                .bind(this)}
                                href={this.getUrl(data + 1)}
                                key={data + 1}
                                iconClassName=''
                    ...
                    {this.props.pagination.next
                        ? this._paginationLink(+ 1, 'next', 'next')
                        : null}
                </div>
            </div>
        );
